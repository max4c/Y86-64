...
const int MRMOVQ = 0x5;  // ASSOCIATED WITH ICODE
const int OPQ = 0x6;
const int JXX = 0x7;
const int CALL = 0x8;
const int RET = 0x9;
...
/** BEGIN Function IDs **/
const int ADD = 0x0;
const int SUB = 0x1;      // operations e.g. ICODE - 6 IFUN - 1 means SUBQ
const int AND = 0x2;
const int XOR = 0x3;
...
const int LE = 0x1;
const int L = 0x2;
const int E = 0x3;        // jumps e.g. ICODE - 7 IFUN - 5 means JGE
const int NE = 0x4; 
const int GE = 0x5;
const int G = 0x6;
/** END Function IDs **/
